...
public class ViewStatusBar implements Drawable{
	...
	private BufferedImage heart, mana,money, hp, fireArmor, iceArmor;
	...
	public ViewStatusBar(Spieler sp, int width)
	{
		...
		try {
			...
			this.fireArmor= ImageIO.read(new File("images/feuerschild.png"));
			this.iceArmor=ImageIO.read(new File("images/eisschild.png"));
		} catch (IOException e) {
	...
	public void draw(Graphics g) {
		...
		g.drawImage(fireArmor,320,5,null);
		g.setColor(Color.orange);
		g.setFont(new Font("Arial", Font.BOLD, 20));
		g.drawString(String.valueOf(sp.getFireArmor()), 350,
				22);
		
		g.drawImage(iceArmor,270,5,null);
		g.setColor(Color.blue);
		g.setFont(new Font("Arial", Font.BOLD, 20));
		g.drawString(String.valueOf(sp.getIceArmor()), 290,
				22);
