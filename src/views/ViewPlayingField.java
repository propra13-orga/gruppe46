...
try{
		for (int i = 0; i < pf.getItemList().size(); i++) {
			...
			if(pf.getItemList().get(i).getClass().getName().equals("models.FireArmor"))
			{
				vitem.setImage("images/FireArmor.png");
				itvl.add(vitem);
			}
			if(pf.getItemList().get(i).getClass().getName().equals("models.IceArmor"))
			{
				vitem.setImage("images/IceArmor.png");
				itvl.add(vitem);
			}
